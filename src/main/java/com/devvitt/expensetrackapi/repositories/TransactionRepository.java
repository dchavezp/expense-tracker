...
import com.devvitt.expensetrackapi.repositories.interfaces.TransactionRepositoryI;
...
public class TransactionRepository implements TransactionRepositoryI {
    ...
    private static final String SQL_FIND_ALL = "SELECT TRANSACTION_ID, CATEGORY_ID, USER_ID, AMOUNT, NOTE, TRANSACTION DATE " +
            "FROM ET_TRANSACTIONS WHERE USER_ID = ? AND CATEGORY_ID = ?";
    private static final String SQL_FIND_BY_ID = "SELECT TRANSACTION_ID, CATEGORY_ID, USER_ID, AMOUNT, NOTE, TRANSACTION DATE " +
    ...
    private RowMapper<Transaction> transactionRowMapper = ((rs, rowNum) -> new Transaction(
