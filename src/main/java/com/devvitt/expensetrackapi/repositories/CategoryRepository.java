...
import com.devvitt.expensetrackapi.repositories.interfaces.CategoryRepositoryI;
...
public class CategoryRepository implements CategoryRepositoryI {
    ...
    private static final String SQL_REMOVE_ALL_TRANSACTION = "DELETE FROM ET_TRANSACTION WHERE CATEGORY_ID = ?";
    ...
    private void removeAllCatTransactions(Integer categoryId) {
        jdbcTemplate.update(SQL_REMOVE_ALL_TRANSACTION, categoryId);
    }
